    ...
    public function run(): void
    {
        ...
        $integrations = [
            [
                ...
                'driver' => Integration::DRIVER_BUILTIN,
            ...
            [
                'name' => 'Custom Shared Payment Script',
                'type' => Integration::TYPE_PAYMENT,
                'driver' => Integration::DRIVER_CUSTOM_HTTP,
                'provider' => 'Shared Hosting',
                'settings' => ['payload_format' => 'json'],
                'endpoint_url' => 'https://example.com/hooks/payment.php',
                'endpoint_method' => 'POST',
                'endpoint_headers' => ['X-Secret' => 'demo-secret'],
                'endpoint_payload_template' => json_encode([
